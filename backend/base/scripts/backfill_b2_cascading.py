...
from base.db.orm import ProgramIssueDetail
...
def main():
    ...
    try:
        rows = (
            ...
            .filter(ProgramIssueDetail.raw_json != None)  # noqa: E711
        ...
        session.commit()
        print(f"[B2 表] 完成: 回填 {updated} 行, 跳过(无级联数据) {skipped} 行")
