...
API_BT_ROUTE_INDEX: List[Dict[str, str]] = [
    ...
    # ai_token
    {
        "module": "ai_token",
        "method": "GET",
        "path": "/api/bt/ai/token/status",
        "desc": "读取 AI token 配置与当前有效期状态（不回传明文 token）",
        "handler": "route_registry.ai_token.ai_token_status",
        "service": "services.ai_token_service.get_ai_token_status_service",
    },
    {
        "module": "ai_token",
        "method": "POST",
        "path": "/api/bt/ai/token/refresh",
        "desc": "手动刷新 AI token 并回写 config.json",
        "handler": "route_registry.ai_token.ai_token_refresh",
        "service": "services.ai_token_service.refresh_ai_token_service",
    },
    {
        "module": "ai_token",
        "method": "GET",
        "path": "/api/bt/ai/token/authorization",
        "desc": "获取可用 Authorization 头（自动检测过期并刷新）",
        "handler": "route_registry.ai_token.ai_token_authorization",
        "service": "services.ai_token_service.get_ai_authorization_header_service",
    },
    {
        "module": "ai_chat",
        "method": "GET",
        "path": "/api/bt/ai/models",
        "desc": "获取可用 AI 模型列表（用于前端模型选择）",
        "handler": "route_registry.ai_chat.ai_models",
        "service": "services.ai_chat_service.get_ai_models_service",
    },
    {
        "module": "ai_chat",
        "method": "POST",
        "path": "/api/bt/ai/chat/session_message",
        "desc": "AI 真正会话模式：复用 conversationId 的长会话，仅发送当前问题",
        "handler": "route_registry.ai_chat.ai_chat_session_message",
        "service": "services.ai_chat_service.send_session_message_service",
    },
    {
        "module": "ai_chat",
        "method": "POST",
        "path": "/api/bt/ai/chat/session_end",
        "desc": "AI 真正会话模式：结束并释放指定 conversationId 会话",
        "handler": "route_registry.ai_chat.ai_chat_session_end",
        "service": "services.ai_chat_service.end_session_service",
    },
    {
        "module": "ai_chat",
        "method": "POST",
        "path": "/api/bt/ai/chat/single_task",
        "desc": "AI 单任务测试：通过 /api/v1/task 打通闭环（推荐先测此接口）",
        "handler": "route_registry.ai_chat.ai_chat_single_task",
        "service": "services.ai_chat_service.run_single_task_service",
    },
    {
        "module": "ai_chat",
        "method": "POST",
        "path": "/api/bt/ai/chat/multi_turn",
        "desc": "AI 多轮对话测试：同一会话内按 prompts 顺序请求并返回各轮结果",
        "handler": "route_registry.ai_chat.ai_chat_multi_turn",
        "service": "services.ai_chat_service.run_multi_turn_chat_service",
    },
    # db_sync
    {
        "module": "db_sync",
